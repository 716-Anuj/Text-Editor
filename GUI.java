...
public class GUI implements ActionListener {
    ...
    // FORMAT MENU
    JMenuItem iWrap, iFontArial, iFontCSMS, iFontTimesNR, iFontSize8, iFontSize12, iFontSize16, iFontSize20, iFontSize24, iFontSize28;
    ...
    public GUI()
    {
        ...
        format.setFont((format.selectedFont));
        format.wordWrap();
    ...
    public void createFormatMenu()
    {
        ...
        iFontTimesNR = new JMenuItem("TIMES NEW ROMAN");
        iFontTimesNR.addActionListener(this);
        iFontTimesNR.setActionCommand("TIMES NEW ROMAN");
        menuFont.add(iFontTimesNR);
